# -*- coding: utf-8 -*-
# filename: formats/geomax_txt.py
...
"""Geomax TXT format parser.

This format is a simple CSV-like text format exported from Geomax
...
class FormatParser(Parser):
    ...
    def is_point(self, line):
        ...
        if not line:
            return False
        parts = line.split(',')
        # Need at least 4 fields: id, x, y, z
        if len(parts) < 4:
            return False
